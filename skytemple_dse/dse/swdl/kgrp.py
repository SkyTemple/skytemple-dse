...
class SwdlKeygroup(DseAutoString, HasId):
    def __init__(self, data: Union[bytes, memoryview], _assertId: int):
        ...
        self.poly = dse_read_sintle(data, 0x02)
        self.priority = dse_read_uintle(data, 0x03)
        self.vclow = dse_read_uintle(data, 0x04)
        self.vchigh = dse_read_uintle(data, 0x05)
        self.unk50 = dse_read_uintle(data, 0x06)
        self.unk51 = dse_read_uintle(data, 0x07)
    ...
    def to_bytes(self):
        data = bytearray(8)
        dse_write_uintle(data, self.id, 0, 2)
        dse_write_sintle(data, self.poly, 2)
        dse_write_uintle(data, self.priority, 3)
        dse_write_uintle(data, self.vclow, 4)
        dse_write_uintle(data, self.vchigh, 5)
        dse_write_uintle(data, self.unk50, 6)
        dse_write_uintle(data, self.unk51, 7)
        return data
...
class SwdlKgrp:
    ...
    def to_bytes(self) -> bytes:
        ...
        dse_write_uintle(buffer, len_chunk, 0x0C, 4)
        return buffer + chunk
